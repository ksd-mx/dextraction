      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
              ...
              <div key={item.name}>
                {item.enabled ? (
                  <Link
                    href={item.path}
                    className={cn(
                      "px-4 py-2 rounded-lg font-medium transition text-small tracking-wider",
                      pathname === item.path
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg font-medium text-[#94A3B8] hover:text-white hover:bg-[#202535] transition text-small tracking-wider"
                  >
                    {item.name}
                  </button>
                )}
          ...
          <div className="flex items-center gap-2">
            <button className="p-2 rounded-lg text-[#94A3B8] hover:text-white hover:bg-[#202535]">
              <Settings size={20} />
            </button>
            ...
            {isConnected ? (
              ...
              <button
                ...
                className="bg-[#AFD803] hover:bg-[#9DC503] text-[#111827] rounded-lg px-4 py-2 transition font-medium text-small tracking-wider"
              >
                CONNECT WALLET
              </button>
            )}
